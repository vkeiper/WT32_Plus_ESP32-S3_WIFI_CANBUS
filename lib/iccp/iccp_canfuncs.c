...
#define CANCMDCOUNT     5 //EAJ 2015/11/18 Was 3 - Added 203 and 204
...
void CANWrite(uint8_t psuadr,uint8_t dcadr,uint16_t funcid,uint8_t *data, uint8_t datalength)
{
	...
	b_CANTXFlag = CanTxBufferMutator(data,datalength, canid);
}
/******************************************************************************/
...
void CANLoadSyntax()
{
	...
	//EAJ 2015/11/18 Added 203 and 204
...
void CANFunction_201(uint8_t *cmd, uint32_t id,uint8_t dlc)
{
	...
	switch (frm_cnt[lclpsuidx])
	{
		...
		case 3: // Frame 4 contains....
			...
			GuiState.SysDataPSU[lclpsuidx].pflparams.refelec_active = cmd[7];		
			//GuiState.SysDataPSU[lclpsuidx].Status |= 0x0004;// OR ON bit 2 "Profile RXD bit"
				
		break;
		
		case 4: // Frame 5 contains....
			//	int16_t refelec_dmd_setpt;  // resolution 1mv/bit  -2048 = -.5Vdc  +2048= +.5Vdc. (2 bytes)
			//char refeleclongname[4][16]; //refeleclongname[0][0]thru[4] (5 bytes)
			GuiState.SysDataPSU[lclpsuidx].pflparams.refelec_dmd_setpt  = cmd[1] + (cmd[2] * 0x100);
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][0] = cmd[3];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][1] = cmd[4];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][2] = cmd[5];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][3] = cmd[6];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][4] = cmd[7];
		break;
		
		case 5: // Frame 6 contains....
			//char refeleclongname[4][16]; //refeleclongname[0][5]thru[11] (7 bytes)
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][5] = cmd[1];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][6] = cmd[2];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][7] = cmd[3];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][8] = cmd[4];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][9] = cmd[5];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][10] = cmd[6];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][11] = cmd[7];		
		break;
		...
		case 6: // Frame 7 contains....
			...
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][12] = cmd[1];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][13] = cmd[2];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][14] = cmd[3];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][15] = cmd[4];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][0] = cmd[5];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][1] = cmd[6];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][2] = cmd[7];		
		break;
		
		case 7: // Frame 8 contains....
			//char refeleclongname[4][16]; //refeleclongname[1][3]thru[9]   (7 bytes)
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][3] = cmd[1];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][4] = cmd[2];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][5] = cmd[3];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][6] = cmd[4];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][7] = cmd[5];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][8] = cmd[6];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][9] = cmd[7];		
		break;
		...
		case 8: // Frame 9 contains....
			...
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][10] = cmd[1];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][11] = cmd[2];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][12] = cmd[3];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][13] = cmd[4];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][14] = cmd[5];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][15] = cmd[6];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][0] = cmd[7];		
		break;
		
		case 9: // Frame 10 contains....
			//char refeleclongname[4][16]; //refeleclongname[2][1]thru[7]   (7 bytes)
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][1] = cmd[1];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][2] = cmd[2];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][3] = cmd[3];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][4] = cmd[4];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][5] = cmd[5];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][6] = cmd[6];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][7] = cmd[7];		
		break;
		
		case 10: // Frame 11 contains....
			//char refeleclongname[4][16]; //refeleclongname[2][8]thru[14]  (7 bytes)
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][8] = cmd[1];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][9] = cmd[2];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][10] = cmd[3];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][11] = cmd[4];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][12] = cmd[5];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][13] = cmd[6];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][14] = cmd[7];		
		break;
		...
		case 11: // Frame 12 contains....
			...
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][15] = cmd[1];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][0] = cmd[2];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][1] = cmd[3];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][2] = cmd[4];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][3] = cmd[5];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][4] = cmd[6];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][5] = cmd[7];		
		break;
		
		case 12: // Frame 13 contains....
			//char refeleclongname[4][16]; //refeleclongname[3][6]thru[12] (7 bytes)
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][6] = cmd[1];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][7] = cmd[2];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][8] = cmd[3];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][9] = cmd[4];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][10] = cmd[5];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][11] = cmd[6];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][12] = cmd[7];		
		break;
		
		case 13: // Frame 14 contains....
			//char refeleclongname[4][16]; //refeleclongname[3][13]thru[15] (3 bytes)
			//spare (5 bytes)
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][13] = cmd[1];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][14] = cmd[2];
			GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][15] = cmd[3];
			GuiState.SysDataPSU[lclpsuidx].pflparams.rec_vset      = cmd[4] + (cmd[5] * 0x100);
			GuiState.SysDataPSU[lclpsuidx].pflparams.rec_iset      = cmd[6] + (cmd[7] * 0x100);
			//canBuff[4] = 0xff;//Spare byte not used in profile just sent 8 so DLC is same in all frames
			//canBuff[5] = 0xff;//Spare byte not used in profile just sent 8 so DLC is same in all frames
			//canBuff[6] = 0xff;//Spare byte not used in profile just sent 8 so DLC is same in all frames
		...
		case 0xFF:
			...
			// the PSU is telling us it does not have a ICCP profile programmed yet.
...
void CANFunction_203(uint8_t *cmd, uint32_t id,uint8_t dlc)
{
	...
	// Profile struct contains 27 bytes of data, we use 7 bytes of the 8 byte CAN frame payload
	// for prfile data and 1 byte for the frame index. So we need 4 frames to get 27 bytes of data
	switch (frm_cnt[lclpsuidx])
	{
		case 0:  //first frame contains 
		...
		case 2:// Frame 3 contains....
			...
			//	uint16_t alarm_reg_mask;  // 0= bit masked 1= active, same bit mapping as alarm register
			//	uint16_t self_test_int;// interval self test is run at in minutes/bit 0= disbaled
			canBuff[1] = GuiState.SysDataPSU[lclpsuidx].pflparams.rec_iset_min_th >>8; //EAJ 12/04/2015 ">>8" was missing
		...
		case 3: // Frame 4 contains....
			...
			canBuff[7] = GuiState.SysDataPSU[lclpsuidx].pflparams.refelec_active;
			//canBuff[7] = 0xff;//Spare byte not used in profile just sent 8 so DLC is same in all frames
		...
		case 4: // Frame 5 contains....
			//	int16_t refelec_dmd_setpt;  // resolution 1mv/bit  -2048 = -.5Vdc  +2048= +.5Vdc. (2 bytes)
			//char refeleclongname[4][16]; //refeleclongname[0][0]thru[4] (5 bytes)
			canBuff[1] = GuiState.SysDataPSU[lclpsuidx].pflparams.refelec_dmd_setpt & 0x00FF; //LO BYTE
			canBuff[2] = GuiState.SysDataPSU[lclpsuidx].pflparams.refelec_dmd_setpt >>8; 			//HI BYTE
			canBuff[3] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][0];
			canBuff[4] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][1];
			canBuff[5] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][2];
			canBuff[6] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][3];
			canBuff[7] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][4];
			//canBuff[7] = 0xff;//Spare byte not used in profile just sent 8 so DLC is same in all frames
		...
		case 5: // Frame 6 contains....
			//char refeleclongname[4][16]; //refeleclongname[0][5]thru[11] (7 bytes)
			canBuff[1] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][5];
			canBuff[2] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][6];
			canBuff[3] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][7];
			canBuff[4] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][8];
			canBuff[5] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][9];
			canBuff[6] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][10];
			canBuff[7] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][11];		
		break;
		
		case 6: // Frame 7 contains....
			//char refeleclongname[4][16]; //refeleclongname[0][12]thru[15] (4 bytes)
			//char refeleclongname[4][16]; //refeleclongname[1][0]thru[2]   (3 bytes)
			canBuff[1] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][12];
			canBuff[2] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][13];
			canBuff[3] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][14];
			canBuff[4] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[0][15];
			canBuff[5] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][0];
			canBuff[6] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][1];
			canBuff[7] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][2];		
		break;
		
		case 7: // Frame 8 contains....
			//char refeleclongname[4][16]; //refeleclongname[1][3]thru[9]   (7 bytes)
			canBuff[1] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][3];
			canBuff[2] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][4];
			canBuff[3] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][5];
			canBuff[4] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][6];
			canBuff[5] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][7];
			canBuff[6] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][8];
			canBuff[7] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][9];		
		break;
		
		case 8: // Frame 9 contains....
			//char refeleclongname[4][16]; //refeleclongname[1][10]thru[15] (6 bytes)
			//char refeleclongname[4][16]; //refeleclongname[2][0]          (1 byte)
			canBuff[1] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][10];
			canBuff[2] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][11];
			canBuff[3] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][12];
			canBuff[4] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][13];
			canBuff[5] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][14];
			canBuff[6] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[1][15];
			canBuff[7] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][0];		
		break;
		
		case 9: // Frame 10 contains....
			//char refeleclongname[4][16]; //refeleclongname[2][1]thru[7]   (7 bytes)
			canBuff[1] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][1];
			canBuff[2] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][2];
			canBuff[3] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][3];
			canBuff[4] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][4];
			canBuff[5] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][5];
			canBuff[6] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][6];
			canBuff[7] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][7];		
		break;
		
		case 10: // Frame 11 contains....
			//char refeleclongname[4][16]; //refeleclongname[2][8]thru[14]  (7 bytes)
			canBuff[1] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][8];
			canBuff[2] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][9];
			canBuff[3] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][10];
			canBuff[4] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][11];
			canBuff[5] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][12];
			canBuff[6] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][13];
			canBuff[7] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][14];		
		break;
		
		case 11: // Frame 12 contains....
			//char refeleclongname[4][16]; //refeleclongname[2][15] 			 (1 byte)
			//char refeleclongname[4][16]; //refeleclongname[3][0]thru[5]  (6 bytes)
			canBuff[1] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[2][15];
			canBuff[2] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][0];
			canBuff[3] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][1];
			canBuff[4] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][2];
			canBuff[5] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][3];
			canBuff[6] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][4];
			canBuff[7] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][5];		
		break;
		
		case 12: // Frame 13 contains....
			//char refeleclongname[4][16]; //refeleclongname[3][6]thru[12] (7 bytes)
			canBuff[1] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][6];
			canBuff[2] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][7];
			canBuff[3] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][8];
			canBuff[4] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][9];
			canBuff[5] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][10];
			canBuff[6] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][11];
			canBuff[7] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][12];		
		break;
		
		case 13: // Frame 14 contains....
			//char refeleclongname[4][16]; //refeleclongname[3][13]thru[15] (3 bytes)
			//spare (5 bytes)
			canBuff[1] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][13];
			canBuff[2] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][14];
			canBuff[3] = GuiState.SysDataPSU[lclpsuidx].pflparams.refeleclongname[3][15];
			canBuff[4] = GuiState.SysDataPSU[lclpsuidx].pflparams.rec_vset & 0x00FF;
			canBuff[5] = GuiState.SysDataPSU[lclpsuidx].pflparams.rec_vset >>8;
			canBuff[6] = GuiState.SysDataPSU[lclpsuidx].pflparams.rec_iset & 0x00FF;
			canBuff[7] = GuiState.SysDataPSU[lclpsuidx].pflparams.rec_iset >>8;	
...
void CANFunction_204(uint8_t *cmd, uint32_t id,uint8_t dlc)
{
	...
	switch (frm_cnt[lclpsuidx])
	{
		...
		case 3: // Frame 4 contains....
			...
			//	uint8_t control_int;// interval the rectifer output current is updated based on the ref elec AVG buffers. second/bit 
			//  uint32_t tsts_active; // bit mapped to each test in the self test routine, to allow us to select which tests will be run
			//	uint8_t  refelec_active; // bit mapped to each electrode (bits 0:3)
			canBuff[1] = GuiState.SysDataPSU[lclpsuidx].pflparams.adc_smp_int;
			canBuff[2] = GuiState.SysDataPSU[lclpsuidx].pflparams.control_int;
			canBuff[3] = GuiState.SysDataPSU[lclpsuidx].pflparams.tsts_active & 0x000000ff;
			canBuff[4] = GuiState.SysDataPSU[lclpsuidx].pflparams.tsts_active >>8 & 0x000000ff;
