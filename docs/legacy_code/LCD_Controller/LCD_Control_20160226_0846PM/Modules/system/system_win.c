...
GUI_CONST_STORAGE GUI_BITMAP bmatdi_vsmallsys = {
  40, // xSize
  20, // ySize
  160, // BytesPerLine
  32, // BitsPerPixel
...
static const GUI_WIDGET_CREATE_INFO _aDialogSystemInformation[] = {
  ...
  { TEXT_CreateIndirect, "Board : ICCP Defender", ID_TEXT_BOARD, 40, 24, 280, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "Core: STM32F429 Cortex M4", ID_TEXT_CORE, 40, 44, 280, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "CPU Speed : 180MHz", ID_TEXT_CPU, 40, 64, 280, 20, 0, 0x0, 0 },
  { TEXT_CreateIndirect, "Firmware Version : P1.0.0", ID_TEXT_VERSION, 40, 84, 280, 20, 0, 0x0, 0 },
  { IMAGE_CreateIndirect, "Image", ID_IMAGE_LOGO, 140, 110, 40, 20, 0, 0, 0 },  
  { TEXT_CreateIndirect, "Copyright (c) AstrodyneTDI 2015", ID_TEXT_COPYRIGHT, 40, 142, 280, 20, 0, 0x0, 0 },  
};

static const GUI_WIDGET_CREATE_INFO _aDialogGeneralSettings[] = {
  { WINDOW_CreateIndirect, "Network Settings", 0, 0,   0, 329, 202, FRAMEWIN_CF_MOVEABLE },
  ...
  { TEXT_CreateIndirect, "[!! Restart the controller to apply the new settings !!]", ID_TEXT_WARNING, 6, 160, 300, 20, 0, 0x0, 0 },  
};
...
static void _cbSystemInformation(WM_MESSAGE * pMsg) 
{
  ...
  case WM_INIT_DIALOG:
    ...
    IMAGE_SetBitmap(hItem, &bmatdi_vsmallsys);//&bmSTLogo40x20);
...
static void _cbDialog(WM_MESSAGE * pMsg) {
  ...
  case WM_INIT_DIALOG:
    ...
    IMAGE_SetBitmap(hItem, &bmsysinfo_trans);
