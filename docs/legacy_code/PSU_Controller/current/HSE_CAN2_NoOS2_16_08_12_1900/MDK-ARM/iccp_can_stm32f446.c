...
static void CANHW_Config(void)
{
    ...
    CanHandle.Init.BS1          = CAN_BS1_8TQ;    //// was 12
    CanHandle.Init.BS2          = CAN_BS2_1TQ;    //// was 2
    CanHandle.Init.Prescaler    = 18;             //// was 12
...
void HAL_CAN_RxCpltCallback(CAN_HandleTypeDef* CanHandle)
{
	...
	CanApiEnqueue(CanHandle->pRxMsg->ExtId, lclCanBuff, CanHandle->pRxMsg->DLC); 
